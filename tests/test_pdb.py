...
def test_get_peptide_chains():
    test_data = [{'chain': 'B', 'atom': 'N', 'remnant': 'LYS',
                 ...
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -29.596, 'y': 40.891, 'position': '1', 'z': 20.714},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -30.421, 'y': 42.06, 'position': '2', 'z': 20.397},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -30.371, 'y': 42.343, 'position': '2A', 'z': 18.883},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
    ...
    expected_output = [{'peptide': '-KIF', 'startsite': 1, 'endsite': 4, 'chain': 'B'},
                       {'peptide': 'FF----------FFFFFI', 'startsite': 1, 'endsite': 18, 'chain': 'D'}]
...
def test_get_peptide_chains_exceptions():
    test_data = [{'chain': 'B', 'atom': 'N', 'remnant': 'LYS',
                  'x': -49.836, 'y': 78.687, 'position': '2', 'z': 6.238},
                 {'chain': 'B', 'atom': 'N', 'remnant': 'ILE',
                  'x': -50.865, 'y': 78.249, 'position': '2', 'z': 5.299},
                 {'chain': 'B', 'atom': 'N', 'remnant': 'PHE',
                  'x': -50.534, 'y': 78.611, 'position': '2', 'z': 3.838},
                 {'chain': 'B', 'atom': 'O', 'remnant': 'LYS',
                  'x': -50.243, 'y': 79.77, 'position': '2', 'z': 3.527}]

    test_data_2= [{'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -29.596, 'y': 40.891, 'position': '1', 'z': 20.714},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -30.421, 'y': 42.06, 'position': '2', 'z': 20.397},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -30.371, 'y': 42.343, 'position': '2A', 'z': 18.883},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -29.787, 'y': 43.336, 'position': '10', 'z': 18.412},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -30.001, 'y': 43.276, 'position': '9', 'z': 21.229},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -29.939, 'y': 43.099, 'position': '8', 'z': 22.73},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -31.074, 'y': 43.269, 'position': '4', 'z': 23.513},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'PHE',
                  'x': -28.725, 'y': 42.878, 'position': '3', 'z': 23.371},
                 {'chain': 'D', 'atom': 'N', 'remnant': 'ILE',
                  'x': -30.999, 'y': 43.178, 'position': '2', 'z': 24.91}]
    ...
    try:
        actual_output=get_peptide_chains(test_data_2)
    except:
        pass
    assert actual_output == None
